...
Sload1 = pygame.image.load("1.png")
Sload1 = pygame.transform.scale(Sload1, (100, 100))
Sload2 = pygame.image.load("2.png")
Sload2 = pygame.transform.scale(Sload2, (100, 100))
Sload3 = pygame.image.load("3.png")
...
SPlayer1image = pygame.image.load("SumoH.png")
SPlayer1image = pygame.transform.scale(SPlayer1image, (105, 105))
SPlayer2image = pygame.image.load("SumoE.png")
...
Stime = 0
Srandomdirection = 0
Sdownarrow = pygame.image.load("downarrow.png")
Sdownarrow = pygame.transform.scale(Sdownarrow, (100, 100))
Sleftarrow = pygame.image.load("leftarrow.png")
Sleftarrow = pygame.transform.scale(Sleftarrow, (100, 100))
Srightarrow = pygame.image.load("rightarrow.png")
